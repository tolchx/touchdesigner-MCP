...
- **1255 tests offline** nativos de Node.js que garantizan que el MCP se ejecute de forma robusta e independiente de TD, más **116 tests offline del bridge en Python** (`tests/test_api_contract_offline.py` 67 + `tests/test_td_api_offline.py` 49, todos verdes), **19 tests offline de sintaxis GLSL POP** (`tests/test_glsl_pop_offline.py`) y **19 tests del gate del baseline POP** (`tests/test_pop_matrix_baseline.py`).
