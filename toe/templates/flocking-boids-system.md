...
TMPEOF && cat > /path/to/touchdesigner/toe/templates/fluid-curl-noise.md << 'TMPEOF'
...
TMPEOF && cat > /path/to/touchdesigner/toe/templates/fractal-lsystem.md << 'TMPEOF'
# Fractal L-System
...
TMPEOF && cat > /path/to/touchdesigner/toe/templates/data-visualization.md << 'TMPEOF'
