#!/usr/bin/env python3
"""
Generador del script Python que va dentro del Text DAT del .tox de TouchDesigner MCP.

Uso:
    python mcp/setup/create_tox.py

Esto imprime el código completo de la extensión TouchDesignerAPI
que debe pegarse en el Text DAT dentro del Base COMP del .tox.
"""
...
def generate_toe_extension_script():
    """
    Genera el script Python completo para embeker dentro del .tox.

    Este script es una versión autocontenida de TouchDesignerAPI.py
    que se ejecuta como extensión de un Text DAT dentro de un Base COMP
    exportado como .tox. No depende de archivos externos.
    """
...
def main():
    script = generate_toe_extension_script()

    # Determinar ruta de salida
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_path = os.path.join(script_dir, "toe_extension.py")
    ...
    print("  2. Crea un Base COMP")
    print("  3. Dentro, crea un Text DAT")
    print(f"  4. Pega el contenido de {output_path} en el Text DAT")
    print("  5. Configura el Text DAT como extensión (ver tox_instructions.md)")
    print("  6. Agrega un WebServer DAT y un Execute DAT")
    print("  7. Exporta como .tox")
