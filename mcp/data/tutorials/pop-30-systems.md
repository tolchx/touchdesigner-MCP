---
title: "30 POP Systems — Parameter Experiments"
category: "pops"
difficulty: "intermediate"
keywords: ["pop", "noise", "math", "copy", "limit", "attribute", "feedback", "cache", "blend", "particle", "systems", "parameter experiments"]
duration: "45 min"
requires_td: true
---
...
Treinta sistemas POP verificados contra TouchDesigner build 2025.32460, organizados en 8 categorías. Cada sistema es un experimento de parámetros con una cadena de operadores específica.

**Resultado: 30/30 OK, 0 errores**

## Row 0: Noise Variations (5 sistemas)
...
## Row 1: Math Transforms (5 sistemas)
...
## Row 2: Copy Variations (5 sistemas)
...
## Row 5: Feedback + Cache (3 sistemas)
...
## Row 7: Multi-operator (5 sistemas)
