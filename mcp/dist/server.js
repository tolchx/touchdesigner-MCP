 ...
 */
async function registerAllTools(server, client) {
 ...
 */
export async function createTouchDesignerMcpServer(client = new TDClient()) {
 ...
 * online/offline mode.
 */
export async function createTouchDesignerMcpServerWithStatus(client = new TDClient()) {
    ...
    server.resource("TD Status", "td://status", {
