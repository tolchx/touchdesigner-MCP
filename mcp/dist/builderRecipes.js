 ...
 */
function feedbackLoopTOP() {
    const description = "Generative art feedback loop: noiseTOP seeds a feedback accumulator. " +
 ...
 */
function particleSystemPOP() {
    const description = "GPU particle system with feedback solver loop: spherePOP emits seed points, " +
 ...
 */
function glslTOPShader() {
    const description = "GLSL pixel shader pipeline: two constantTOPs feed a glslTOP as " +
...
function audioReactive() {
    const description = "Audio-reactive spectrum visualizer: audiofileinCHOP loads and plays audio, " +
...
function renderScene3D() {
    const description = "Complete 3D render pipeline: a geometryCOMP contains a light, camera, " +
 ...
 */
export function listRecipeNames() {
