...
export type TdnParameterValue = string | number | boolean | {
    expr: string;
} | {
    bind: string;
};
/** Operator flag names. Prefixed with '-' to set false. */
export type TdnFlagName = "bypass" | "lock" | "display" | "render" | "viewer" | "expose" | "allowCooking";
export type TdnFlags = string[];
/** Custom parameter style enumeration. */
export type TdnParStyle = "Float" | "Int" | "XY" | "XYZ" | "XYZW" | "WH" | "UV" | "UVW" | "RGB" | "RGBA" | "Str" | "Menu" | "StrMenu" | "Toggle" | "Pulse" | "Momentary" | "Header" | "File" | "FileSave" | "Folder" | "Python" | "OP" | "COMP" | "TOP" | "CHOP" | "SOP" | "DAT" | "MAT" | "POP" | "Object" | "PanelCOMP" | "Sequence";
...
export type TdnCustomParsGrouped = Record<string, TdnCustomParDef[] | TdnTemplateRef>;
...
export type TdnStorageValue = string | number | boolean | null | TdnStorageValue[] | {
...
export declare const TDN_VOLATILE_KEYS: readonly ["build", "generator", "td_build", "exported_at", "source_file"];
