 ...
 */
export function registerGlslApplyTools(server, client) {
    server.registerTool("td_glsl_analyze", {
        title: "Analyze GLSL POP Shader",
        description: "Statically analyze a GLSL POP shader against the verified rules " +
    ...
    server.registerTool("td_glsl_apply", {
        title: "Apply GLSL POP",
        description: "Create a glslPOP that COMPILES: pre-validates the shader (rejects " +
