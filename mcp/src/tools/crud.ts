    ...
    "td_create_operator",
    {
      ...
      inputSchema: {
        ...
        replace: z
          ...
          .default(false)
          .describe(
            "Destroy an existing operator with the same name first (docs/MCP_REAL_CASES.md F6). " +
        ...
        numelems: z
          ...
          .optional()
          .describe(
            "Number of elements for GLSL POPs. Auto-set to 100 for glslPOP/glslCreatePOP/glslAdvancedPOP. " +
