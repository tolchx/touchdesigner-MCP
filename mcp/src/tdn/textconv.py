#!/usr/bin/env python3
"""Git textconv driver for .tdn (TouchDesigner Network) files.
...
build number, export timestamp, TD version, source .toe name -- that
changes without the network changing. Without this driver, a plain
...
The stripped key set is kept in sync with the TDN_VOLATILE_KEYS constant
in mcp/src/tdn/schema.ts.
"""
...
# network changing. Keep in sync with TDN_VOLATILE_KEYS in schema.ts.
