import json
res = {"recipe": "top-value-noise", "errors": [], "created": [], "pixels": {}, "feedback": None}
try:
    parent = op("/project1")
    if parent is None:
    ...
    code = parent.create(td.textDAT, "vis_value_noise_code")
    ...
    g = parent.create(td.glslTOP, "vis_value_noise")
