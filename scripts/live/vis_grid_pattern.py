import json
res = {"recipe": "top-grid-pattern", "errors": [], "created": [], "pixels": {}, "feedback": None}
try:
    parent = op("/project1")
    if parent is None:
    ...
    code = parent.create(td.textDAT, "vis_grid_pattern_code")
    ...
    g = parent.create(td.glslTOP, "vis_grid_pattern")
